...
namespace 
{
    ...
    RestAPI::JsonResponse handlePatchJsonURI(const JsonURI& jsonURI, const json& data, bool allowAdding = false)
    {
...
void PowerMeterAPI::createTrackerEndpoints()
{
    Globals::API.registerURI("/trackers", HTTP::Method::GET, [](json){
        ...
        return RestAPI::JsonResponse(data, HTTP::StatusCode::OK, {{"Content-Disposition", "inline"}});
    });
